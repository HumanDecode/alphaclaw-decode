...
const kKnownVars = [
  {
    key: "ALPHACLAW_INSTANCE_NAME",
    label: "Instance Name",
    group: "branding",
    hint: "Shown on the login screen and sidebar, e.g. Edna",
  },
  {
    key: "ALPHACLAW_LOGO_URL",
    label: "Logo URL",
    group: "branding",
    hint: "HTTPS or same-origin path for the login and sidebar logo",
  },
  {
    key: "ALPHACLAW_FAVICON_URL",
    label: "Favicon URL",
    group: "branding",
    hint: "HTTPS or same-origin path; defaults to the logo",
  },
  {
