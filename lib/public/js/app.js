...
import { formatVersionLabel } from "./lib/version-label.js";
...
const App = () => {
  ...
  const footerVersion = formatVersionLabel({
    openclawVersion: controllerState.acCurrentOpenclawVersion,
    alphaclawVersion: controllerState.acVersion,
    decodeVersion: controllerState.acDecodeVersion,
  });
  ...
  return html`
    ...
    >
      ...
      <${AppSidebar}
        ...
        branding=${controllerState.branding}
